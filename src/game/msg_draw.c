...
Vtx gMsgSpeechBoxLQuad[4] = {
    ...
    { .v = { .ob = {32, 0, 0},          .tc = {0x400, 0},       .cn = {255, 255, 248, 255} } },
    { .v = { .ob = {1, -64, 0},         .tc = {0, 0x7F0},       .cn = {191, 184, 176, 255} } },
    { .v = { .ob = {32, -64, 0},        .tc = {0x400, 0x7F0},   .cn = {191, 184, 176, 255} } },
};

Vtx gMsgSpeechBoxMQuad[] = {
    { .v = { .ob = {32, 0, 0},          .tc = {0, 0},            .cn = {255, 255, 248, 255} } },
    { .v = { .ob = {225, 0, 0},         .tc = {0x100, 0},        .cn = {255, 255, 248, 255} } },
    { .v = { .ob = {32, -64, 0},        .tc = {0, 0x7F0},        .cn = {191, 184, 176, 255} } },
    { .v = { .ob = {225, -64, 0},       .tc = {0x100, 0x7F0},    .cn = {191, 184, 176, 255} } },
};

Vtx gMsgSpeechBoxRQuad[] = {
    { .v = { .ob = {225, 0, 0},         .tc = {0, 0},             .cn = {255, 255, 248, 255} } },
    { .v = { .ob = {256, 0, 0},         .tc = {0x400, 0},         .cn = {255, 255, 248, 255} } },
    { .v = { .ob = {225, -64, 0},       .tc = {0, 0x7F0},         .cn = {191, 184, 176, 255} } },
    { .v = { .ob = {256, -64, 0},       .tc = {0x400, 0x7F0},     .cn = {191, 184, 176, 255} } },
};

Vtx gMsgArrowQuad1[] = {
    { .v = { .ob = {-15, 30, 0},        .tc = {0, 0},             .cn = {191, 184, 176, 255} } },
    { .v = { .ob = {15, 30, 0},         .tc = {0x1E0, 0},         .cn = {191, 184, 176, 255} } },
    { .v = { .ob = {-1, 0, 0},          .tc = {0, 0x1E0},         .cn = {191, 184, 176, 255} } },
