...
// Dimensions are patched at runtime from OTR texture metadata by the SetCI handler
HudScript HES_WhirlwindBubble = HES_TEMPLATE_CI_CUSTOM_SIZE(battle_action_cmd_whirlwind_bubble, 0, 0);
