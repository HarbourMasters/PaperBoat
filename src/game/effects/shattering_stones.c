...
void shattering_stones_appendGfx(void* effect) {
    ...
    gSPDisplayList(gMainGfxPos++, LOAD_ASSET(D_09000C00_341480));
    ...
    if (part->unk_24 == 0) {
        ...
        gSPDisplayList(gMainGfxPos++, LOAD_ASSET(D_E002C940[0]));
