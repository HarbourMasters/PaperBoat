...
void fright_jar_appendGfx(void* effect) {
    ...
    gSPDisplayList(gMainGfxPos++, LOAD_ASSET(D_09008BE0_3CA780));
    ...
    for (i = 0; i < 10; i++) {
        ...
        gDPSetTextureImage(gMainGfxPos++, G_IM_FMT_CI, G_IM_SIZ_8b, 64, LOAD_ASSET(D_09002020_3C3BC0));
        ...
        gDPSetTextureImage(gMainGfxPos++, G_IM_FMT_CI, G_IM_SIZ_8b, 64, LOAD_ASSET(D_09000000_3C1BA0));
