...
API_CALLABLE(ShowShopPurchaseDialog) {
    ...
    // functionTempBool[2].b is speech printer isClosed writeback
    ...
    switch (script->functionTemp[0]) {
        case PURCHASE_DIALOG_STATE_INIT:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTempBool[2].b = false;
                D_80286528 = msg_get_printer_for_msg(MSG_Choice_0001, &script->functionTempBool[2].b);
            }
            break;
        case PURCHASE_DIALOG_STATE_WAIT_FOR_SPEECH:
            if (script->functionTempBool[2].b == true) {
    ...
    switch (script->functionTemp[0]) {
        case DIALOG_STATE_AWAIT_GREETING:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTempBool[2].b = false;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0003, &script->functionTempBool[2].b);
            }
            break;
        ...
        case DIALOG_STATE_AWAIT_SELL_CONFIRM:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTempBool[2].b = false;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0002, &script->functionTempBool[2].b);
            }
            break;
        ...
        case DIALOG_STATE_INIT_SELL_MORE_CHOICE:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTempBool[2].b = false;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0004, &script->functionTempBool[2].b);
            }
            break;
        ...
        case DIALOG_STATE_INIT_CHECK_MORE_CHOICE:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTempBool[2].b = false;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0005, &script->functionTempBool[2].b);
            }
            break;
