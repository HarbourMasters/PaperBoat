...
// Symbols normally assigned by the ROM linker script
// (ver/*/undefined_syms.txt). Define only the ones we need on PC so far.
...
// NOTE: heap_battleHead moved to heaps2.c for consistency with other heap
// definitions. It must be a u8[BATTLE_HEAP_SIZE] array, not a HeapNode struct!
