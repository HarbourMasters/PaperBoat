...
// int _Printf(char *(*prout)(char*, const char*, size_t), char *arg, const char *fmt, va_list args);
//
// prout: output function that copies 'size' bytes from 'src' to wherever 'dest' points,
