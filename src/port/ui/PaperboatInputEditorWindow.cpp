...
void PaperboatInputEditorWindow::GetButtonColorsForDeviceType(Ship::PhysicalDeviceType lusIndex, ImVec4& buttonColor,
...
void PaperboatInputEditorWindow::DrawButtonLine(const char* buttonName, uint8_t port, N64ButtonMask bitmask,
...
void PaperboatInputEditorWindow::DrawStickDirectionLineAddMappingButton(uint8_t port, uint8_t stick,
...
void PaperboatInputEditorWindow::DrawStickDirectionLineEditMappingButton(uint8_t port, uint8_t stick,
...
void PaperboatInputEditorWindow::DrawStickDirectionLine(const char* axisDirectionName, uint8_t port, uint8_t stick,
...
void PaperboatInputEditorWindow::DrawMapping(CustomButtonMap& mapping, float labelWidth,
