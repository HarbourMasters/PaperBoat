...
void Window::DrawRegularNotification(
...
void Window::DrawEnhancedNotification(
    const Options& notification, ImVec2 basePosition, int position, float padding, int index
) {
...
void EmitAchievementProgressWithEvent(
    const char* iconPath, const char* eventName, const char* achievementName, int current, int target
) {
    char progressText[128];
