...
void InputViewer::RenderButton(
    std::string btnTexture, std::string btnOutlineTexture, int state, ImVec2 size, int outlineMode
) {
...
void InputViewer::DrawElement() {
    if (CVarGetInteger(CVAR_WINDOW("InputViewer"), 0)) {
        ...
        ImVec2 bgSize = std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
        ...
        ImGui::SetNextWindowContentSize(ImVec2(
            scaledBGSize.x,
            scaledBGSize.y
                + (showAnalogAngles ? 15 : 0) * scale * CVarGetFloat(CVAR_INPUT_VIEWER("AnalogAngles.Scale"), 1.0f)
        ));
        ...
        OSContPad* pads = std::dynamic_pointer_cast<LUS::ControlDeck>(ControllerGetControlDeck())->GetPads();

        ImGuiWindowFlags windowFlags = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar
            | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoFocusOnAppearing;
        ...
        if (pads != nullptr && ImGui::Begin("Input Viewer", nullptr, windowFlags)) {
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("BBtn"), 1)) {
                ...
                RenderButton(
                    "B-Btn", "B-Btn Outline", pads[0].button & BTN_B, scaledBGSize,
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("ABtn"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "A-Btn", "A-Btn Outline", pads[0].button & BTN_A, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CUp"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "C-Up", "C-Up Outline", pads[0].button & BTN_CUP, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CLeft"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "C-Left", "C-Left Outline", pads[0].button & BTN_CLEFT, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CRight"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "C-Right", "C-Right Outline", pads[0].button & BTN_CRIGHT, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CDown"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "C-Down", "C-Down Outline", pads[0].button & BTN_CDOWN, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("LBtn"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "L-Btn", "L-Btn Outline", pads[0].button & BTN_L, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("RBtn"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "R-Btn", "R-Btn Outline", pads[0].button & BTN_R, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("ZBtn"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "Z-Btn", "Z-Btn Outline", pads[0].button & BTN_Z, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("StartBtn"), 1)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "Start-Btn", "Start-Btn Outline", pads[0].button & BTN_START, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("Dpad"), 0)) {
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "Dpad-Left", "Dpad-Left Outline", pads[0].button & BTN_DLEFT, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "Dpad-Right", "Dpad-Right Outline", pads[0].button & BTN_DRIGHT, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
                        : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED)
                );
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "Dpad-Up", "Dpad-Up Outline", pads[0].button & BTN_DUP, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
                        : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED)
                );
                ...
                ImGui::SetCursorPos(aPos);
                RenderButton(
                    "Dpad-Down", "Dpad-Down Outline", pads[0].button & BTN_DDOWN, scaledBGSize,
                    useGlobalOutlineMode
                        ? buttonOutlineMode
                        : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED)
                );
                ...
                || (analogStickMode == STICK_MODE_HIDDEN_IN_DEADZONE && !analogStickIsInDeadzone))
            {
                ...
                ImGui::SetCursorPos(ImVec2(
                    aPos.x + maxStickDistance * ((float) (pads[0].stick_x) / MAX_AXIS_RANGE) * scale,
                ...
                || (rightStickMode == STICK_MODE_HIDDEN_IN_DEADZONE && !rightStickIsInDeadzone))
            {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(ImVec2(
                    aPos.x + maxRightStickDistance * ((float) (pads[0].right_stick_x) / MAX_AXIS_RANGE) * scale,
            ...
            if (showAnalogAngles) {
                ImGui::SetCursorPos(ImVec2(
                    aPos.x + 10 + CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Offset"), 0) * scale,
                           ...
                           && (rSquared >= (range2Min * range2Min)) && (rSquared < (range2Max * range2Max)))
                {
                    ImGui::PushStyleColor(
                        ImGuiCol_Text,
                        VecFromRGBA8(
                            CVarGetColor(CVAR_INPUT_VIEWER("AnalogAngles.Range2.Color.Value"), range2ColorDefault)
                        )
                    );
                } else {
                    ImGui::PushStyleColor(
...
void InputViewerSettingsWindow::DrawElement() {
    // gInputViewer.Scale
    CVarSliderFloat(
        "Input Viewer Scale: %.2f", CVAR_INPUT_VIEWER("Scale"),
        FloatSliderOptions()
            .Color(THEME_COLOR)
            .DefaultValue(1.0f)
            .Min(0.1f)
    ...
    CVarCheckbox(
        "Enable Dragging", CVAR_INPUT_VIEWER("EnableDragging"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
    );
    ...
    CVarCheckbox(
        "Show Background Layer", CVAR_INPUT_VIEWER("ShowBackground"),
    ...
    if (ImGui::CollapsingHeader("Buttons")) {
        ...
        CVarCombobox(
            ...
            ComboboxOptions(
                { { .disabled = !CVarGetInteger(CVAR_INPUT_VIEWER("UseGlobalButtonOutlineMode"), 1),
                    .disabledTooltip = "Disabled because Global Button Outline is off" } }
            )
                .Color(THEME_COLOR)
                .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
                .Tooltip(
                    "Sets the desired visibility behavior for the "
        ...
        // gInputViewer.ABtn
        CVarCheckbox(
            "Show A-Button Layers", CVAR_INPUT_VIEWER("ABtn"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("ABtn"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##ABtnOutline", CVAR_INPUT_VIEWER("ABtnOutlineMode"), buttonOutlineOptionsVerbose,
        ...
        // gInputViewer.BBtn
        CVarCheckbox(
            "Show B-Button Layers", CVAR_INPUT_VIEWER("BBtn"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("BBtn"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##BBtnOutline", CVAR_INPUT_VIEWER("BBtnOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.CUp
        CVarCheckbox(
            "Show C-Up Layers", CVAR_INPUT_VIEWER("CUp"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("CUp"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##CUpOutline", CVAR_INPUT_VIEWER("CUpOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.CRight
        CVarCheckbox(
            "Show C-Right Layers", CVAR_INPUT_VIEWER("CRight"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("CRight"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##CRightOutline", CVAR_INPUT_VIEWER("CRightOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.CDown
        CVarCheckbox(
            "Show C-Down Layers", CVAR_INPUT_VIEWER("CDown"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("CDown"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##CDownOutline", CVAR_INPUT_VIEWER("CDownOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.CLeft
        CVarCheckbox(
            "Show C-Left Layers", CVAR_INPUT_VIEWER("CLeft"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("CLeft"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##CLeftOutline", CVAR_INPUT_VIEWER("CLeftOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.LBtn
        CVarCheckbox(
            "Show L-Button Layers", CVAR_INPUT_VIEWER("LBtn"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("LBtn"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##LBtnOutline", CVAR_INPUT_VIEWER("LBtnOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.RBtn
        CVarCheckbox(
            "Show R-Button Layers", CVAR_INPUT_VIEWER("RBtn"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("RBtn"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##RBtnOutline", CVAR_INPUT_VIEWER("RBtnOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.ZBtn
        CVarCheckbox(
            "Show Z-Button Layers", CVAR_INPUT_VIEWER("ZBtn"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("ZBtn"), 1)) {
            ImGui::Indent();
            CVarCombobox(
                "##ZBtnOutline", CVAR_INPUT_VIEWER("ZBtnOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        ...
        CVarCheckbox(
            "Show Start Button Layers", CVAR_INPUT_VIEWER("StartBtn"),
            CheckboxOptions().Color(THEME_COLOR).DefaultValue(true)
        );
        ...
        // gInputViewer.Dpad
        CVarCheckbox(
            "Show D-Pad Layers", CVAR_INPUT_VIEWER("Dpad"), CheckboxOptions().Color(THEME_COLOR).DefaultValue(false)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("Dpad"), 0)) {
            ImGui::Indent();
            CVarCombobox(
                "##DpadOutline", CVAR_INPUT_VIEWER("DpadOutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.Mod1
        CVarCheckbox(
            "Show Modifier Button 1 Layers", CVAR_INPUT_VIEWER("Mod1"),
            CheckboxOptions().Color(THEME_COLOR).DefaultValue(false)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("Mod1"), 0)) {
            ImGui::Indent();
            CVarCombobox(
                "##Mmod1Outline", CVAR_INPUT_VIEWER("Mod1OutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
        // gInputViewer.Mod2
        CVarCheckbox(
            "Show Modifier Button 2 Layers", CVAR_INPUT_VIEWER("Mod2"),
            CheckboxOptions().Color(THEME_COLOR).DefaultValue(false)
        );
        if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("Mod2"), 0)) {
            ImGui::Indent();
            CVarCombobox(
                "##Mod2Outline", CVAR_INPUT_VIEWER("Mod2OutlineMode"), buttonOutlineOptionsVerbose,
                ComboboxOptions().Color(THEME_COLOR).DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
            );
            ImGui::Unindent();
        }
    ...
    if (ImGui::CollapsingHeader("Analog Stick")) {
        ...
        CVarCombobox(
            ...
            ComboboxOptions()
                ...
                .Tooltip(
                    "Determines the conditions under which the moving layer "
        ...
        CVarCombobox(
            ...
            ComboboxOptions()
                ...
                .DefaultIndex(STICK_MODE_ALWAYS_SHOWN)
                .Tooltip(
                    "Determines the conditions under which the analog stick "
        ...
        CVarSliderInt(
            ...
            IntSliderOptions()
                ...
                .ShowButtons(true)
                .Tooltip(
                    "Sets the distance to move the analog stick in "
    ...
    if (ImGui::CollapsingHeader("Additional (\"Right\") Stick")) {
        ...
        CVarCombobox(
            ...
            ComboboxOptions()
                ...
                .DefaultIndex(STICK_MODE_ALWAYS_HIDDEN)
                .Tooltip(
                    "Determines the conditions under which the right "
        ...
        CVarSliderInt(
            ...
            IntSliderOptions()
                ...
                .ShowButtons(true)
                .Tooltip(
                    "Sets the distance to move the right stick in the input "
    ...
    if (ImGui::CollapsingHeader("Analog Angle Values")) {
        ...
        if (CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Enabled"), 0)) {
            ...
            CVarColorPicker(
                "Text Color", CVAR_INPUT_VIEWER("AnalogAngles.TextColor"), textColorDefault, true,
            ...
            CVarSliderInt(
                ...
                IntSliderOptions()
                    ...
                    .ShowButtons(true)
                    .Tooltip(
                        "Sets the distance to move the right stick in "
            ...
            CVarCheckbox(
                ...
                CheckboxOptions()
                    .Color(THEME_COLOR)
                    .Tooltip(
                        "Highlights the angle value text when the analog stick "
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range1.Enabled"), 0)) {
                ...
                CVarColorPicker(
                    "ESS Color", CVAR_INPUT_VIEWER("AnalogAngles.Range1.Color"), range1ColorDefault, true,
                    ColorPickerRandomButton | ColorPickerResetButton
                );
            }
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range2.Enabled"), 0)) {
                ...
                CVarColorPicker(
                    "Walking Speed Color", CVAR_INPUT_VIEWER("AnalogAngles.Range2.Color"), range2ColorDefault, true,
                    ColorPickerRandomButton | ColorPickerResetButton
                );
            }
        }
