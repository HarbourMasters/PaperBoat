...
static std::unordered_map<int32_t, const char *> stickModeOptions = {
    {STICK_MODE_ALWAYS_SHOWN, "Always"},
    {STICK_MODE_HIDDEN_IN_DEADZONE, "While In Use"},
    {STICK_MODE_ALWAYS_HIDDEN, "Never"}};

InputViewer::~InputViewer() { SPDLOG_TRACE("destruct input viewer"); }

void InputViewer::RenderButton(std::string btnTexture,
                               std::string btnOutlineTexture, int state,
                               ImVec2 size, int outlineMode) {
  const ImVec2 pos = ImGui::GetCursorPos();
  ImGui::SetNextItemAllowOverlap();
  // Render Outline based on settings
  if (outlineMode == BUTTON_OUTLINE_ALWAYS_SHOWN ||
      (outlineMode == BUTTON_OUTLINE_NOT_PRESSED && !state) ||
...
void InputViewer::DrawElement() {
  if (CVarGetInteger(CVAR_WINDOW("InputViewer"), 0)) {
    ...
    if (!sButtonTexturesLoaded) {
      ...
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Start-Btn",
      ...
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Right-Stick",
                                    "textures/buttons/RightStick.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("A-Btn Outline",
                                    "textures/buttons/ABtnOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("B-Btn Outline",
                                    "textures/buttons/BBtnOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("L-Btn Outline",
                                    "textures/buttons/LBtnOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("R-Btn Outline",
                                    "textures/buttons/RBtnOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Z-Btn Outline",
                                    "textures/buttons/ZBtnOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Start-Btn Outline",
                                    "textures/buttons/StartBtnOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("C-Left Outline",
                                    "textures/buttons/CLeftOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("C-Right Outline",
                                    "textures/buttons/CRightOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("C-Up Outline",
                                    "textures/buttons/CUpOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("C-Down Outline",
                                    "textures/buttons/CDownOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Analog-Stick Outline",
                                    "textures/buttons/AnalogStickOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Dpad-Left Outline",
                                    "textures/buttons/DPadLeftOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Dpad-Right Outline",
                                    "textures/buttons/DPadRightOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Dpad-Up Outline",
                                    "textures/buttons/DPadUpOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Dpad-Down Outline",
                                    "textures/buttons/DPadDownOutline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Modifier-1 Outline",
                                    "textures/buttons/Mod1Outline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Modifier-2 Outline",
                                    "textures/buttons/Mod2Outline.png");
      std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
          ->LoadTextureFromRawImage("Right-Stick Outline",
...
#endif
    const int showAnalogAngles =
        CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Enabled"), 0);
    const int buttonOutlineMode = CVarGetInteger(
        CVAR_INPUT_VIEWER("ButtonOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED);
    const bool useGlobalOutlineMode =
        CVarGetInteger(CVAR_INPUT_VIEWER("UseGlobalButtonOutlineMode"), 1);

    ImVec2 bgSize =
        std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())->GetTextureSize(
            "Input-Viewer-Background");
    ...
    ImGui::SetNextWindowContentSize(ImVec2(
        scaledBGSize.x,
        scaledBGSize.y +
            (showAnalogAngles ? 15 : 0) * scale *
                CVarGetFloat(CVAR_INPUT_VIEWER("AnalogAngles.Scale"), 1.0f)));
    ImGui::SetNextWindowPos(ImVec2(mainPos.x + size.x - scaledBGSize.x - 30,
                                   mainPos.y + size.y - scaledBGSize.y - 30),
                            ImGuiCond_FirstUseEver);

    ImGui::PushStyleColor(ImGuiCol_WindowBg, ImVec4(0, 0, 0, 0));
    ImGui::PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2(0.0f, 0.0f));

    OSContPad *pads = std::dynamic_pointer_cast<LUS::ControlDeck>(
    ...
    if (pads != nullptr && ImGui::Begin("Input Viewer", nullptr, windowFlags)) {
      ...
      if (CVarGetInteger(CVAR_INPUT_VIEWER("ShowBackground"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        // Background
        ImGui::Image(std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
      ...
      if (CVarGetInteger(CVAR_INPUT_VIEWER("BBtn"), 1)) {
        ...
        RenderButton("B-Btn", "B-Btn Outline", pads[0].button & BTN_B,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("BBtnOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      if (CVarGetInteger(CVAR_INPUT_VIEWER("ABtn"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("A-Btn", "A-Btn Outline", pads[0].button & BTN_A,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("ABtnOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      ...
      if (CVarGetInteger(CVAR_INPUT_VIEWER("CUp"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("C-Up", "C-Up Outline", pads[0].button & BTN_CUP,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("CUpOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      if (CVarGetInteger(CVAR_INPUT_VIEWER("CLeft"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("C-Left", "C-Left Outline", pads[0].button & BTN_CLEFT,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("CLeftOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      if (CVarGetInteger(CVAR_INPUT_VIEWER("CRight"), 1)) {
        ...
        ImGui::SetCursorPos(aPos);
        RenderButton(
            "C-Right", "C-Right Outline", pads[0].button & BTN_CRIGHT,
            scaledBGSize,
            useGlobalOutlineMode
                ? buttonOutlineMode
                : CVarGetInteger(CVAR_INPUT_VIEWER("CRightOutlineMode"),
                                 BUTTON_OUTLINE_NOT_PRESSED));
      }
      if (CVarGetInteger(CVAR_INPUT_VIEWER("CDown"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("C-Down", "C-Down Outline", pads[0].button & BTN_CDOWN,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("CDownOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      ...
      if (CVarGetInteger(CVAR_INPUT_VIEWER("LBtn"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("L-Btn", "L-Btn Outline", pads[0].button & BTN_L,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("LBtnOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      if (CVarGetInteger(CVAR_INPUT_VIEWER("RBtn"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("R-Btn", "R-Btn Outline", pads[0].button & BTN_R,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("RBtnOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      if (CVarGetInteger(CVAR_INPUT_VIEWER("ZBtn"), 1)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("Z-Btn", "Z-Btn Outline", pads[0].button & BTN_Z,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("ZBtnOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      }
      ...
      if (CVarGetInteger(CVAR_INPUT_VIEWER("StartBtn"), 1)) {
        ...
        ImGui::SetCursorPos(aPos);
        RenderButton(
            "Start-Btn", "Start-Btn Outline", pads[0].button & BTN_START,
            scaledBGSize,
            useGlobalOutlineMode
                ? buttonOutlineMode
      ...
      if (CVarGetInteger(CVAR_INPUT_VIEWER("Dpad"), 0)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("Dpad-Left", "Dpad-Left Outline",
                     pads[0].button & BTN_DLEFT, scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("Dpad-Right", "Dpad-Right Outline",
                     pads[0].button & BTN_DRIGHT, scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("Dpad-Up", "Dpad-Up Outline", pads[0].button & BTN_DUP,
                     scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"),
        ...
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        RenderButton("Dpad-Down", "Dpad-Down Outline",
                     pads[0].button & BTN_DDOWN, scaledBGSize,
                     useGlobalOutlineMode
                         ? buttonOutlineMode
                         : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"),
                                          BUTTON_OUTLINE_NOT_PRESSED));
      ...
      //    ImGui::SetNextItemAllowOverlap();
      //    ImGui::SetCursorPos(aPos);
      //    RenderButton("Modifier-1", "Modifier-1 Outline", pads[0].button &
      //    BTN_CUSTOM_MODIFIER1, scaledBGSize,
      //        useGlobalOutlineMode
      //        ? buttonOutlineMode
      //        : CVarGetInteger(CVAR_INPUT_VIEWER("Mod1OutlineMode"),
      //        BUTTON_OUTLINE_NOT_PRESSED));
      //}
      // Modifier 2
      ...
      //    ImGui::SetNextItemAllowOverlap();
      //    ImGui::SetCursorPos(aPos);
      //    RenderButton("Modifier-2", "Modifier-2 Outline", pads[0].button &
      //    BTN_CUSTOM_MODIFIER2, scaledBGSize,
      //        useGlobalOutlineMode
      //        ? buttonOutlineMode
      //        : CVarGetInteger(CVAR_INPUT_VIEWER("Mod2OutlineMode"),
      //        BUTTON_OUTLINE_NOT_PRESSED));
      //}

      const bool analogStickIsInDeadzone = !pads[0].stick_x && !pads[0].stick_y;
      const bool rightStickIsInDeadzone =
          !pads[0].right_stick_x && !pads[0].right_stick_y;

      // Analog Stick
      const int analogOutlineMode =
          CVarGetInteger(CVAR_INPUT_VIEWER("AnalogStick.OutlineMode"),
                         STICK_MODE_ALWAYS_SHOWN);
      const int32_t maxStickDistance =
          CVarGetInteger(CVAR_INPUT_VIEWER("AnalogStick.Movement"), 12);
      if (analogOutlineMode == STICK_MODE_ALWAYS_SHOWN ||
          (analogOutlineMode == STICK_MODE_HIDDEN_IN_DEADZONE &&
           !analogStickIsInDeadzone)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        ImGui::Image(std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
      ...
      const int analogStickMode =
          CVarGetInteger(CVAR_INPUT_VIEWER("AnalogStick.VisibilityMode"),
                         STICK_MODE_ALWAYS_SHOWN);
      if (analogStickMode == STICK_MODE_ALWAYS_SHOWN ||
          (analogStickMode == STICK_MODE_HIDDEN_IN_DEADZONE &&
           !analogStickIsInDeadzone)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(ImVec2(
            aPos.x + maxStickDistance *
                         ((float)(pads[0].stick_x) / MAX_AXIS_RANGE) * scale,
            aPos.y - maxStickDistance *
                         ((float)(pads[0].stick_y) / MAX_AXIS_RANGE) * scale));
        ImGui::Image(std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
      ...
      // Right Stick
      const int32_t maxRightStickDistance =
          CVarGetInteger(CVAR_INPUT_VIEWER("RightStick.Movement"), 7);
      const int rightOutlineMode =
          CVarGetInteger(CVAR_INPUT_VIEWER("RightStick.OutlineMode"),
                         STICK_MODE_ALWAYS_HIDDEN);
      if (rightOutlineMode == STICK_MODE_ALWAYS_SHOWN ||
          (rightOutlineMode == STICK_MODE_HIDDEN_IN_DEADZONE &&
           !rightStickIsInDeadzone)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(aPos);
        ImGui::Image(std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
      ...
      const int rightStickMode =
          CVarGetInteger(CVAR_INPUT_VIEWER("RightStick.VisibilityMode"),
                         STICK_MODE_ALWAYS_HIDDEN);
      if (rightStickMode == STICK_MODE_ALWAYS_SHOWN ||
          (rightStickMode == STICK_MODE_HIDDEN_IN_DEADZONE &&
           !rightStickIsInDeadzone)) {
        ImGui::SetNextItemAllowOverlap();
        ImGui::SetCursorPos(ImVec2(
            aPos.x + maxRightStickDistance *
                         ((float)(pads[0].right_stick_x) / MAX_AXIS_RANGE) *
                         scale,
            aPos.y - maxRightStickDistance *
                         ((float)(pads[0].right_stick_y) / MAX_AXIS_RANGE) *
                         scale));
        ImGui::Image(std::static_pointer_cast<Fast::Fast3dGui>(WindowGetWindowComponent()->GetGui())
      ...
      if (showAnalogAngles) {
        ImGui::SetCursorPos(ImVec2(
            aPos.x + 10 +
                CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Offset"), 0) *
                    scale,
            scaledBGSize.y + aPos.y + 10));
        // Scale font with input viewer scale
        float oldFontScale = ImGui::GetFont()->Scale;
        ImGui::GetFont()->Scale *=
            scale * CVarGetFloat(CVAR_INPUT_VIEWER("AnalogAngles.Scale"), 1.0f);
        ImGui::PushFont(ImGui::GetFont());

        // Calculate polar R coordinate from X and Y angles, squared to avoid
        // sqrt
        const int32_t rSquared = pads[0].stick_x * pads[0].stick_x +
                                 pads[0].stick_y * pads[0].stick_y;

        // ESS range
        const int range1Min =
            CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range1.Min"), 8);
        const int range1Max =
            CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range1.Max"), 27);
        // Walking speed range
        const int range2Min =
            CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range2.Min"), 27);
        const int range2Max =
            CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range2.Max"), 62);

        // Push color based on angle ranges
        if (CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range1.Enabled"),
                           0) &&
            (rSquared >= (range1Min * range1Min)) &&
            (rSquared < (range1Max * range1Max))) {
          ImGui::PushStyleColor(
              ImGuiCol_Text,
              VecFromRGBA8(CVarGetColor(
                  CVAR_INPUT_VIEWER("AnalogAngles.Range1.Color.Value"),
                  range1ColorDefault)));
        } else if (CVarGetInteger(
                       CVAR_INPUT_VIEWER("AnalogAngles.Range2.Enabled"), 0) &&
                   (rSquared >= (range2Min * range2Min)) &&
                   (rSquared < (range2Max * range2Max))) {
          ImGui::PushStyleColor(
              ImGuiCol_Text,
              VecFromRGBA8(CVarGetColor(
                  CVAR_INPUT_VIEWER("AnalogAngles.Range2.Color.Value"),
                  range2ColorDefault)));
        } else {
          ImGui::PushStyleColor(
              ImGuiCol_Text,
              VecFromRGBA8(CVarGetColor(
                  CVAR_INPUT_VIEWER("AnalogAngles.TextColor.Value"),
                  textColorDefault)));
        }
...
void InputViewerSettingsWindow::DrawElement() {
  ...
  if (ImGui::CollapsingHeader("Buttons")) {
    ...
    CVarCombobox("Button Outlines/Backgrounds",
                 CVAR_INPUT_VIEWER("ButtonOutlineMode"), buttonOutlineOptions,
                 ComboboxOptions(
                     {{.disabled = !CVarGetInteger(
                           CVAR_INPUT_VIEWER("UseGlobalButtonOutlineMode"), 1),
                       .disabledTooltip =
                           "Disabled because Global Button Outline is off"}})
                     .Color(THEME_COLOR)
                     .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED)
                     .Tooltip("Sets the desired visibility behavior for the "
                              "button outline/background layers. Useful for "
                              "custom input viewers."));

    // gInputViewer.UseGlobalButtonOutlineMode
    CVarCheckbox("Use for all buttons",
                 CVAR_INPUT_VIEWER("UseGlobalButtonOutlineMode"),
                 CheckboxOptions().Color(THEME_COLOR).DefaultValue(true));

    UIWidgets::PaddedSeparator();

    bool useIndividualOutlines =
        !CVarGetInteger(CVAR_INPUT_VIEWER("UseGlobalButtonOutlineMode"), 1);
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("ABtn"), 1)) {
      ImGui::Indent();
      CVarCombobox("##ABtnOutline", CVAR_INPUT_VIEWER("ABtnOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
      ImGui::Unindent();
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("BBtn"), 1)) {
      ImGui::Indent();
      CVarCombobox("##BBtnOutline", CVAR_INPUT_VIEWER("BBtnOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("CUp"), 1)) {
      ImGui::Indent();
      CVarCombobox("##CUpOutline", CVAR_INPUT_VIEWER("CUpOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    CVarCheckbox("Show C-Right Layers", CVAR_INPUT_VIEWER("CRight"),
                 CheckboxOptions().Color(THEME_COLOR).DefaultValue(true));
    if (useIndividualOutlines &&
        CVarGetInteger(CVAR_INPUT_VIEWER("CRight"), 1)) {
      ImGui::Indent();
      CVarCombobox("##CRightOutline", CVAR_INPUT_VIEWER("CRightOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    CVarCheckbox("Show C-Down Layers", CVAR_INPUT_VIEWER("CDown"),
                 CheckboxOptions().Color(THEME_COLOR).DefaultValue(true));
    if (useIndividualOutlines &&
        CVarGetInteger(CVAR_INPUT_VIEWER("CDown"), 1)) {
      ImGui::Indent();
      CVarCombobox("##CDownOutline", CVAR_INPUT_VIEWER("CDownOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    CVarCheckbox("Show C-Left Layers", CVAR_INPUT_VIEWER("CLeft"),
                 CheckboxOptions().Color(THEME_COLOR).DefaultValue(true));
    if (useIndividualOutlines &&
        CVarGetInteger(CVAR_INPUT_VIEWER("CLeft"), 1)) {
      ImGui::Indent();
      CVarCombobox("##CLeftOutline", CVAR_INPUT_VIEWER("CLeftOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("LBtn"), 1)) {
      ImGui::Indent();
      CVarCombobox("##LBtnOutline", CVAR_INPUT_VIEWER("LBtnOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("RBtn"), 1)) {
      ImGui::Indent();
      CVarCombobox("##RBtnOutline", CVAR_INPUT_VIEWER("RBtnOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("ZBtn"), 1)) {
      ImGui::Indent();
      CVarCombobox("##ZBtnOutline", CVAR_INPUT_VIEWER("ZBtnOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    CVarCheckbox("Show Start Button Layers", CVAR_INPUT_VIEWER("StartBtn"),
                 CheckboxOptions().Color(THEME_COLOR).DefaultValue(true));
    if (useIndividualOutlines &&
        CVarGetInteger(CVAR_INPUT_VIEWER("StartBtn"), 1)) {
      ImGui::Indent();
      CVarCombobox("##StartBtnOutline",
                   CVAR_INPUT_VIEWER("StartBtnOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("Dpad"), 0)) {
      ImGui::Indent();
      CVarCombobox("##DpadOutline", CVAR_INPUT_VIEWER("DpadOutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("Mod1"), 0)) {
      ImGui::Indent();
      CVarCombobox("##Mmod1Outline", CVAR_INPUT_VIEWER("Mod1OutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
    ...
    if (useIndividualOutlines && CVarGetInteger(CVAR_INPUT_VIEWER("Mod2"), 0)) {
      ImGui::Indent();
      CVarCombobox("##Mod2Outline", CVAR_INPUT_VIEWER("Mod2OutlineMode"),
                   buttonOutlineOptionsVerbose,
                   ComboboxOptions()
                       .Color(THEME_COLOR)
                       .DefaultIndex(BUTTON_OUTLINE_NOT_PRESSED));
  ...
  if (ImGui::CollapsingHeader("Analog Stick")) {
    ...
    CVarCombobox(
        ...
        CVAR_INPUT_VIEWER("AnalogStick.VisibilityMode"), stickModeOptions,
        ComboboxOptions()
            .Color(THEME_COLOR)
            .DefaultIndex(STICK_MODE_ALWAYS_SHOWN)
            .Tooltip("Determines the conditions under which the moving layer "
                     "of the analog stick texture is visible."));

    // gInputViewer.AnalogStick.OutlineMode
    CVarCombobox(
        "Analog Stick Outline/Background Visibility",
        CVAR_INPUT_VIEWER("AnalogStick.OutlineMode"), stickModeOptions,
        ComboboxOptions()
            .Color(THEME_COLOR)
            .DefaultIndex(STICK_MODE_ALWAYS_SHOWN)
            .Tooltip("Determines the conditions under which the analog stick "
                     "outline/background texture is visible."));

    // gInputViewer.AnalogStick.Movement
    CVarSliderInt("Analog Stick Movement: %dpx",
                  CVAR_INPUT_VIEWER("AnalogStick.Movement"),
                  IntSliderOptions()
                      .Color(THEME_COLOR)
                      .Min(0)
                      .Max(200)
                      .DefaultValue(12)
                      .ShowButtons(true)
                      .Tooltip("Sets the distance to move the analog stick in "
                               "the input viewer. Useful for custom "
                               "input viewers."));
    UIWidgets::PaddedSeparator(true, true);
  }
  ...
  if (ImGui::CollapsingHeader("Additional (\"Right\") Stick")) {
    ...
    CVarCombobox(
        ...
        CVAR_INPUT_VIEWER("RightStick.VisibilityMode"), stickModeOptions,
        ComboboxOptions()
            .Color(THEME_COLOR)
            .DefaultIndex(STICK_MODE_ALWAYS_HIDDEN)
            .Tooltip("Determines the conditions under which the moving layer "
                     "of the right stick texture is visible."));

    // gInputViewer.RightStick.OutlineMode
    CVarCombobox("Right Stick Outline/Background Visibility",
                 CVAR_INPUT_VIEWER("RightStick.OutlineMode"), stickModeOptions,
                 ComboboxOptions()
                     .Color(THEME_COLOR)
                     .DefaultIndex(STICK_MODE_ALWAYS_HIDDEN)
                     .Tooltip("Determines the conditions under which the right "
                              "stick outline/background texture is visible."));
    ...
    CVarSliderInt(
        ...
        IntSliderOptions()
            ...
            .DefaultValue(7)
            .ShowButtons(true)
            .Tooltip("Sets the distance to move the right stick in the input "
                     "viewer. Useful for custom input viewers."));
    UIWidgets::PaddedSeparator(true, true);
  }
  ...
  if (ImGui::CollapsingHeader("Analog Angle Values")) {
    // gAnalogAngles
    CVarCheckbox(
        "Show Analog Stick Angle Values",
        CVAR_INPUT_VIEWER("AnalogAngles.Enabled"),
        CheckboxOptions()
            .Color(THEME_COLOR)
    ...
    if (CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Enabled"), 0)) {
      ...
      CVarColorPicker("Text Color", CVAR_INPUT_VIEWER("AnalogAngles.TextColor"),
                      textColorDefault, true,
                      ColorPickerRandomButton | ColorPickerResetButton);
      // gAnalogAngleScale
      CVarSliderFloat("Angle Text Scale: %.2f%%",
                      CVAR_INPUT_VIEWER("AnalogAngles.Scale"),
                      FloatSliderOptions()
                          .Color(THEME_COLOR)
                          .IsPercentage()
                          .Min(0.1f)
      ...
      CVarSliderInt("Angle Text Offset: %dpx",
                    CVAR_INPUT_VIEWER("AnalogAngles.Offset"),
                    IntSliderOptions()
                        .Color(THEME_COLOR)
                        .Min(0)
                        .Max(400)
                        .DefaultValue(0)
                        .ShowButtons(true)
                        .Tooltip("Sets the distance to move the right stick in "
                                 "the input viewer. Useful for "
                                 "custom input viewers."));
      UIWidgets::PaddedSeparator(true, true);
      // gInputViewer.AnalogAngles.Range1.Enabled
      CVarCheckbox(
          "Highlight ESS Position",
          CVAR_INPUT_VIEWER("AnalogAngles.Range1.Enabled"),
          CheckboxOptions()
              .Color(THEME_COLOR)
              .Tooltip("Highlights the angle value text when the analog stick "
                       "is in ESS position (on flat ground)"));
      if (CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range1.Enabled"), 0)) {
        // gInputViewer.AnalogAngles.Range1.Color
        CVarColorPicker("ESS Color",
                        CVAR_INPUT_VIEWER("AnalogAngles.Range1.Color"),
      ...
      CVarCheckbox(
          "Highlight Walking Speed Angles",
          CVAR_INPUT_VIEWER("AnalogAngles.Range2.Enabled"),
          CheckboxOptions()
              .Color(THEME_COLOR)
              .Tooltip("Highlights the angle value text when the analog stick "
                       "is at an angle that would "
      ...
      if (CVarGetInteger(CVAR_INPUT_VIEWER("AnalogAngles.Range2.Enabled"), 0)) {
        ...
        CVarColorPicker("Walking Speed Color",
                        CVAR_INPUT_VIEWER("AnalogAngles.Range2.Color"),
