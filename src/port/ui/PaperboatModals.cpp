...
void PaperboatModalWindow::RegisterPopup(std::string title, std::string message, std::string button1,
...
size_t PaperboatModalWindow::PopupsQueued() {
    return modals.size();
}
...
void PaperboatModalWindow::DismissPopup() {
    closePopup = true;
}
