...
void PaperboatMenu::AddSidebarEntry(std::string sectionName, std::string sidebarName, uint32_t columnCount) {
...
WidgetInfo& PaperboatMenu::AddWidget(WidgetPath& pathInfo, std::string widgetName, WidgetType widgetType) {
...
PaperboatMenu::PaperboatMenu(const std::string& consoleVariable, const std::string& name)
...
void PaperboatMenu::UpdateElement() {
    Ship::Menu::UpdateElement();
}

void PaperboatMenu::Draw() {
    Ship::Menu::Draw();
}

void PaperboatMenu::DrawElement() {
