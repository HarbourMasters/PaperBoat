...
extern b32 npc_raycast_down_sides(s32 ignoreFlags, f32* posX, f32* posY, f32* posZ, f32* hitDepth);
...
extern void
transform_point(Matrix4f mtx, f32 inX, f32 inY, f32 inZ, f32 inS, f32* outX, f32* outY, f32* outZ, f32* outW);
...
extern b32 is_point_visible(f32 x, f32 y, f32 z, s32 depthQueryID, f32* screenX, f32* screenY);
...
void shim_draw_box(
    ...
    (void) fpDrawContents;
    draw_box(
        flags, windowStyle, posX, posY, posZ, width, height, opacity, darkening, scaleX, scaleY, rotX, rotY, rotZ, NULL,
        drawContentsArg0, rotScaleMtx, translateX, translateY, *outPtr
    );
}
